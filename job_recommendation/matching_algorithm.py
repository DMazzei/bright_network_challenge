...
from job_recommendation.models import Job, JobLocationPreferences, JobPreferences, Member
...
class MatchingAlgorithm:
    ...
    def get_recommendations(self, candidate: Member, all_jobs: bool = False, **kwargs) -> List[Job]:
        ...
        recommendations = self._filter_matching_result(scored_matches=scored_matches, min_score=min_score, **kwargs)
